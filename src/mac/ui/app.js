// Browser entry point for the modular dashboard source. Keep these files checked
// in so mac does not need a Node.js/npm frontend toolchain to serve the UI.
...
async function loadDashboard() {
  ...
  renderSyncState();
  try {
    state.data = await api.requestJSON("/dashboard/state");
