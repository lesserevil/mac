...
import type { AgentItem, ApiRecord } from "../types.js";
...
export function secretRecord(secret: ApiRecord, agents: AgentItem[]): string {
  return `
...
export function secretAuditRecord(audit: ApiRecord): string {
  return `
